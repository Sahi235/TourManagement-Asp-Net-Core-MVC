        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourRegistrations_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TourRegistrationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_TourRegistrations_TourRegistrationId",
                        column: x => x.TourRegistrationId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "d68ba8ab-7348-488f-ac65-34ff796f5476", "d68ba8ab-7348-488f-ac65-34ff796f5476", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "B22698B8-42A2-4115-9631-1C2D1E2AC5F7", 0, "B22698B8-42A2-4115-9631-1C2D1E2AC5F7", "Admin@gmail.com", true, false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEKfjbbTZ7FpCw/0H+QlCGR3ZHOXtamrIy1zvaPErkcRFhTABwGRrisGLaZ5fjRgxLw==", null, true, "1a9a7669-e530-48aa-bd69-9ced217bf14b", false, "Admin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId", "RoleId1", "UserId1" },
                values: new object[] { "d68ba8ab-7348-488f-ac65-34ff796f5476", "B22698B8-42A2-4115-9631-1C2D1E2AC5F7", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_TourRegistrationId",
                table: "Payments",
                column: "TourRegistrationId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourRegistrations_ClientId",
